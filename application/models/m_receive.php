...
class m_receive extends CI_Model
{
    ...
    public function retrieveReceiveId($id){
        ...
        $query = $this->db->query("SELECT rd.*,ds.remark as ds_remark,ds.sakura_version_no,pc.inner_box_spec,pc.outter_box_spec,pc.packaging_id,pc.created_at as pc_create_at,bom.movex_filter_master,bom.sap_filter_master,bom.status as bom_status,bom.remark as bom_remark,bom.created_at as bom_created_at,bom.movex_filter_master,bom.sap_filter_master
