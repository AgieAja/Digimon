                ...
                <table class="table table-bordered table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $row->ds_remark ?></td>
                                <td>
                                    <a href="#" data-toggle="modal" data-target="#draw_img">Inner Box</a> | 
                                    <a href="#" data-toggle="modal" data-target="#draw_img">Outter Box</a>
                                </td>
...
<div id="draw_img" class="modal fade" role="dialog">
...
foreach ($listDetail as $row) { ?>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo base_url(); ?>BOM/updaterow" method="POST">
      <div class="modal-body">
